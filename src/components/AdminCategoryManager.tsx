...
const AVAILABLE_ICONS = [
  ...
  { name: 'ShieldCheck', label: 'Segurança / Eventos' },
  { name: 'ArrowUpDown', label: 'Elevadores / Deslocamento' },
  { name: 'Headphones', label: 'Atendimento / Suporte' },
  { name: 'UserCheck', label: 'Receção / Atendimento' },
